...
@WebServlet(urlPatterns = "/Homework2/NewsletterSignup", loadOnStartup = 1)
public class NewsletterSignupServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public NewsletterSignupServlet() {
        super();
    }
...
//		} catch (Exception e) {}
		...
		out.println("            <p class=\"lead\">You're all set, <strong>" + mailingList.get(mailingList.size() - 1).getFirstName() + "</strong>!<br />We'll e-mail you at <strong>" + mailingList.get(mailingList.size() - 1).getEmail() + "</strong> with regular updates.</p>");
